...
IDEA N/O enumerates rank sleeves on TRAIN then selects on locked VAL
(pred_r / ridged P(up) / gap-filter / CS z / vote-z / logit4 /
gap*turnover / k-of-M vote / high-dispersion dates). Aimed at VAL 60%
with cover >= 5%. TEST never picks. Dynamic A alpha-blend is not the
60% path. If n_hit_60=0 the report prints a STOP 60% autopsy.
"""
